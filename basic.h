...
// These includes pull in interface definitions and utilities.a
#ifndef _BASIC_H_
#define _BASIC_H_
#include <stdlib.h>
#include <time.h>
...
extern sem_t semLive, semHigh;//WK
extern int FCounter;//to control number of maps to be dumped to file
#endif
