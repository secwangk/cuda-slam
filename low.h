...
#define LOW_DURATION 40//WK, initially 40, just to make images change faster
...
//WK for following
void* doLive(void* arg);
extern int pBest;
extern TParticle savedParticle[PARTICLE_NUMBER];
extern unsigned char map[MAP_WIDTH][MAP_HEIGHT];
extern double lastX, lastY, lastTheta;
